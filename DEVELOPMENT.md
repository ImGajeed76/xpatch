...
This guide provides instructions for building, testing, and contributing to xpatch (v0.4.1).
...
# The build creates a distribution package at:
# crates/xpatch-c/dist/
#   ├── libxpatch_c.{so,dylib,dll}
#   ├── xpatch.h
#   └── README.md
```
...
```bash
# Run Rust-based unit tests (16 comprehensive tests)
cargo test -p xpatch-c
...
# Run C examples
axogen run example basic --lang=c
```

**Development tips:**

- The header file `xpatch.h` is auto-generated by cbindgen during build
- All FFI functions use panic safety (`catch_unwind`)
